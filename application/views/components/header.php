...
<link rel="stylesheet" href="<?=base_url('assets/')?>css/bootstrap.min.css">
    ...
    <link rel="stylesheet" href="<?=base_url('assets/')?>css/fonts.css"></link>
    ...
    <link type="text/css" rel="stylesheet" href="<?=base_url('assets/')?>css/all.css?x=<?php echo time(); ?>"></link>
...
<div class="headerx" id="top">
  ...
  <div id="top1">
    <a href="#top"><button class="button0 button4 button2" style="vertical-align:middle"><span><b><font size="3">&#8679;</font></b></span></button></a><br><br><br>
  </div>
...
<ul class="sidenav">
  ...
  <li>
      ...
      <a class="active" onclick="myAccFunc()" href="<?=base_url('auth')?>">Laman Utama &nbsp;&nbsp;<i class="fa fa-caret-down"></i></a>
        ...
        $role = $this->session->userdata('role_id');
            ...
            {
            ?>
            <a href="<?=base_url('/fungsiutama')?>" class="w3-white"><i class="fa fa-angle-right" aria-hidden="true"></i><span style="margin-left: 1em; font-size: 13px;"></t>Fungsi Utama</a>
            <?php
            
            if($role !=2){
            ?>
            <a href="<?=base_url('/carian')?>" class="w3-white"><i class="fa fa-angle-right" aria-hidden="true"></i><span style="margin-left: 1em; font-size: 13px;">Pencarian</a>
            <a href="<?=base_url('/urusmaklumat')?>" class="w3-white"><i class="fa fa-angle-right aria-hidden="true"></i><span style="margin-left: 1em; font-size: 13px;">Urus Maklumat</a>
            <?php } ?>
            <a href="<?=base_url('/laporan')?>" class="w3-white"><i class="fa fa-angle-right aria-hidden="true"></i><span style="margin-left: 1em; font-size: 13px;">Laporan</a>
            <a href="<?=base_url('/notifikasi')?>" class="w3-white"><i class="fa fa-angle-right aria-hidden="true"></i><span style="margin-left: 1em; font-size: 13px;">Notifikasi</a>
            <a href="<?=base_url('/pengesahan')?>" class="w3-white"><i class="fa fa-angle-right aria-hidden="true"></i><span style="margin-left: 1em; font-size: 13px;">Pengesahan</a>
            <?php
            }
          ?> 
          </div>
...
<?php
     if($role == 1)
            {?>
    <li><a href="<?=base_url('/tetapan')?>"><i class="fa fa-cog" aria-hidden="true"></i> &nbsp; Tetapan  &nbsp;&nbsp;</a></li>
            <?php }?>
    <li><a href="<?=base_url('/user/profile')?>"><i class="fa fa-user"></i>&nbsp; Profile  &nbsp;&nbsp;</a></li>
    <li><a href="<?=base_url('/manual')?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> &nbsp; Manual Pengguna  &nbsp;&nbsp;</a></li>
