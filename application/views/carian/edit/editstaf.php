            ...
            <tr>
                ...
                <td>
                    ...
                    <select name="Jantina" value="Jantina" required>
                        ...
                        <option value="LELAKI" <?php if($query2['Jantina']=="LELAKI"){echo "selected";}?>>LELAKI
                        </option>
                        <option value="PEREMPUAN" <?php if($query2['Jantina']=="PEREMPUAN"){echo "selected";}?>>
                            PEREMPUAN</option>
                    </select>
                </td>
            </tr>
            ...
            <tr>
                <td>
                    ...
                    <select name="GredJawatan" value="GredJawatan">
                        <option value="" disabled selected hidden>&nbsp;--</option>
                        <option value="VK7" <?php if($query2['GredJawatan']=="VK7"){echo "selected";}?>>Professor(VK7)
                        </option>
                        <option value="DM54" <?php if($query2['GredJawatan']=="DM54"){echo "selected";}?>>Professor
                            Madya(DM54)</option>
                        <option value="DM53" <?php if($query2['GredJawatan']=="DM53"){echo "selected";}?>>Professor
                            Madya(DM53)</option>
                        <option value="DM52" <?php if($query2['GredJawatan']=="DM52"){echo "selected";}?>>Pensyarah
                            Kanan(DM52)</option>
                        <option value="DM51" <?php if($query2['GredJawatan']=="DM51"){echo "selected";}?>>Pensyarah
                            Kanan(DM51)</option>
                        <option value="DM46" <?php if($query2['GredJawatan']=="DM46"){echo "selected";}?>>
                            Pensyarah(DM46)</option>
                        <option value="DM45" <?php if($query2['GredJawatan']=="DM45"){echo "selected";}?>>
            ...
            <tr>
                <td>
                    ...
                    <select name="JenisLantikan" value="JenisLantikan">
                        <option value="" disabled selected hidden>&nbsp;--</option>
                        <option value="TETAP" <?php if($query2['JenisLantikan']=='TETAP'){echo 'selected';} ?>>TETAP
                        </option>
                        <option value="SEMENTARA" <?php if($query2['JenisLantikan']=='SEMENTARA'){echo 'selected';}?>>
                            SEMENTARA</option>
                    </select>
                </td>
                <td>
