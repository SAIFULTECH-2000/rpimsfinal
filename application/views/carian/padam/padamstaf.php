...
<section class="form-section">
    ...
    <form method="post" class="borang" action="<?=base_url('/carian/padam_staf')?>">
        <table>
          ...
          ?>
            ...
            <div class="tooltip">
                ...
                <input type="text" placeholder="" name="NamaStaf" value="<?= $query2['NamaStaf']; ?>"
                    readonly="readonly" required />
                <span class=""></span>
            </div><br><br>
            ...
            <div class="tooltip">
             ...
             <option value="inactive">&nbsp;&nbsp;Ya</option>
                ...
                <span class="tooltiptext">Tekan <b>hapus</b> untuk hapuskan staf <br>atau <b>batal</b> untuk
                    kembali.</span>
            </div><br><br>
