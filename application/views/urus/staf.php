        ...
        ?>
            ...
            <tr>
                <td>
                    <b>No Pekerja :</b>
                    <br>
                    <input type="text" placeholder="" name="NoPekerja" data-toggle='tooltip' data-placement='left'
                        title='Sila isikan No Pekerja yang sesuai. Contoh format kod : 000001.' required />
                </td>
                <td>
                    <b>No Kad Pengenalan :</b>
                    <br>
                    <input type="text" placeholder="" name="NoICStaf" data-toggle='tooltip' data-placement='left'
            ...
            <tr>
                ...
                <td>
                    <button type="submit" class="button-ungu button4" name="btn-signup" value="Update">Daftar
                        Staf</button>
                </td>
            </tr>
        </table>
